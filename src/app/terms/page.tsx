    ...
    <main className="min-h-screen py-24 px-4 max-w-4xl mx-auto text-gray-300">
      ...
      <div className="space-y-8 leading-relaxed">
        ...
        <section>
          ...
          <p>For questions about these terms, contact us at <a href="mailto:build@chilliboys.mx" className="text-copper hover:underline">build@chilliboys.mx</a> or via WhatsApp at +52 612 105 2006.</p>
        </section>
      </div>
